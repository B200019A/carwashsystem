...
.</p>
    ...
    <div class="w3-col m6">
      <img class="w3-image w3-round-large" src="{{asset('images/welcomePage/sudu-logo.png')}}" alt="Buildings" width="700" height="250">
    </div>
  </div>
</div>
...
<footer class="w3-center w3-black w3-padding-32">
  <a onclick="topFunction()" class="w3-button w3-light-grey"><i class="fa fa-arrow-up w3-margin-right"></i>To the top</a>
 
  <p>Design by<a href="" title="W3.CSS" target="_blank" class="w3-hover-text-green">JJ</a></p>
</footer>
