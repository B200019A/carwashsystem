        ...
        <div class="login-container">
            <div class="signup-content">
                <div class="signup-form">
                    ...
                    @CSRF
                     <input id="role" type="hidden" class="" name="role" value="0" readonly="true">
...
<footer class="w3-center w3-black w3-padding-32">
  ...
  <p style="color: white !important;">Design by<a href="" title="W3.CSS" target="_blank" class="w3-hover-text-blue">JJ</a></p>
</footer>
